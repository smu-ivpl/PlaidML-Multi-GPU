...
from src.model.ssd_layers import Normalize
from src.model.ssd_layers import PriorBox
...
def SSD(input_shape, n_class=21):
    ...
    conv4_3_norm_mbox_conf = Conv2D(n_boxes[0] * 21, (3, 3), padding='same', name="conv4_3_norm_mbox_conf")(
        conv4_3_norm)
    conv4_3_norm_mbox_conf_reshape = Reshape((-1, n_class), name='conv4_3_norm_mbox_conf_reshape')(
        conv4_3_norm_mbox_conf)
    conv4_3_norm_mbox_priorbox = PriorBox(img_size, min_size=30.0, max_size=60.0, aspect_ratios=[1.0, 2.0, 0.5],
    ...
    fc7_mbox_priorbox = PriorBox(img_size, min_size=60.0, max_size=114.0, aspect_ratios=[1.0, 2.0, 0.5, 3.0, 1.0 / 3.0],
                                 variances=[0.1, 0.1, 0.2, 0.2], name='fc7_mbox_priorbox')(fc7)
    ...
    conv6_2_mbox_priorbox = PriorBox(img_size, min_size=114.0, max_size=168.0,
                                     aspect_ratios=[1.0, 2.0, 0.5, 3.0, 1.0 / 3.0], variances=[0.1, 0.1, 0.2, 0.2],
    ...
    conv7_2_mbox_priorbox = PriorBox(img_size, min_size=168.0, max_size=222.0,
                                     aspect_ratios=[1.0, 2.0, 0.5, 3.0, 1.0 / 3.0], variances=[0.1, 0.1, 0.2, 0.2],
    ...
    conv8_2_mbox_priorbox = PriorBox(img_size, min_size=222.0, max_size=276.0, aspect_ratios=[1.0, 2.0, 0.5],
    ...
    conv9_2_mbox_priorbox = PriorBox(img_size, min_size=276.0, max_size=330.0, aspect_ratios=[1.0, 2.0, 0.5],
                                     variances=[0.1, 0.1, 0.2, 0.2], name='conv9_2_mbox_priorbox')(conv9_2)
